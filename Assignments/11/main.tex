...
\begin{enumerate}[itemsep=0pt,topsep=0pt,label=\alph*)]
  ...
  \begin{align*}
    ...
    \end{cases}.
  \end{align*}
  \item The acoefifcients are found by the normalization condition:
  \begin{align*}
  ...
  \end{align*}
  \item We do the analogous process for the expectation value of $H$. The potential energy s easy to compute:
  \begin{align*}
