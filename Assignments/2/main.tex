...
\begin{enumerate}[itemsep=0pt,topsep=0pt,label=(\alph*)]
  ...
  \item
    \begin{enumerate}[itemsep=0pt,topsep=0pt,label=(b.\arabic*)]
      ...
      exponential of the wave $\varphi(x)$. Knowing also that the mass have dimension of $[M]$ and $\hbar^2$ of $[M^2L^4T^{-2}]$, doing dimensional analysis with the last equation above yields
      \begin{align*}
